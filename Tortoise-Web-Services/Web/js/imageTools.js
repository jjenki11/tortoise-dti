...
var imageTools = function (){	
  ...
  function returnPTestImageArray(imageArr, numImages, userImage, controlImage)
  {
    ...
    */
    ...
    var numset = getRandomSubarray(createNumberLine(0,numImages-1), numImages);
    var tmp = [];
    tmp.push(userImage);
	...
	function setImage(canvas, url, w, h)
	{
		...
		canvas.height = (w!=null) ? w : 950;
		canvas.width = (h!=null) ? h : 750;
		base_image = new Image();
		base_image.src = url;
		base_image.onload = function(){
			context.drawImage(base_image, 0, 0, (w!=null) ? w : 950, (h!=null) ? h : 750);
		}
	};
